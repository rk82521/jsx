...
const UserOpinionSection = () => {
  return (
    <section className=" bg-white z-10 relative to-black py-16 px-4 sm:px-8 md:px-16 w-[88%] ml-10 mr-20 ">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        
       
        <h2 className="   text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-black text-center md:text-left font-[var(--font-nunito)]  font-bold">
        ...
        <div className="flex flex-col gap-6 overflow-y-auto max-h-[70vh]  pr-2">
          {testimonials.map((item, index) => (
            ...
            >
              <p className="text-sm sm:text-base md:text-lg font-[var(--font-dm-sans)] text-lg text-gray-200 ">
                {item.text}
              </p>
